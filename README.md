...
**Figure 1: Inverted pendulum stabilized with LQR control ($\theta_{\text{init}} = 0$, $Q = \begin{bmatrix} 100 & 0 \\ 0 & 1 \end{bmatrix}$, $R = 0.1$).**
...
$$
\dot{x} = A x + B u, \quad
x = \begin{bmatrix}\theta \\ \dot{\theta}\end{bmatrix}, \\ u = \tau
$$
